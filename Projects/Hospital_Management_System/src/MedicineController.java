...
public class MedicineController {
    ...
    private VBox buildMedicinesPane(Physician physician) {
        ...
        // Table
        TableView<ObservableMedicine> table = new TableView<>();
        TableColumn<ObservableMedicine, Integer> idCol = new TableColumn<>("ID");
        idCol.setCellValueFactory(d -> d.getValue().idProperty().asObject());
        TableColumn<ObservableMedicine, String> nameCol = new TableColumn<>("Name");
        nameCol.setCellValueFactory(d -> d.getValue().nameProperty());
        TableColumn<ObservableMedicine, String> catCol = new TableColumn<>("Category");
        catCol.setCellValueFactory(d -> d.getValue().categoryProperty());
        TableColumn<ObservableMedicine, String> unitCol = new TableColumn<>("Unit");
        unitCol.setCellValueFactory(d -> d.getValue().unitProperty());
        TableColumn<ObservableMedicine, String> priceCol = new TableColumn<>("Price (Rs)");
        priceCol.setCellValueFactory(d -> d.getValue().priceProperty());
        TableColumn<ObservableMedicine, String> addedCol = new TableColumn<>("Added By");
